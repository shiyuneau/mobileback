...
public class HotNewsController {
    ...
    @ResponseBody
    @RequestMapping("/list")
    public JsonResult hotNewsList(@RequestParam(value = "pageNum",required = false) Integer pageNum, @RequestParam(value = "pageSize",required = false) Integer pageSize) {
        ...
        return articleService.hotNewsList(pageNum,pageSize);
    }
